...
export function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-end md:items-end justify-start overflow-hidden"
    >
      {/* Background Video */}
      ...
      <div className="relative z-10 w-full max-w-full px-5 md:px-8 lg:px-12 pt-72 md:pt-24 pb-24 md:pb-16 lg:pb-20">
